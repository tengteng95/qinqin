...
public class UserFriendAdapter extends BaseAdapter implements SectionIndexer {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.location = (TextView) convertView.findViewById(R.id.tv_friend_location);
		...
		final BmobGeoPoint location = friend.getLocation();
        ...
        //new MKSearch().reverseGeocode(location);
