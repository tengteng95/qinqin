...
public class CustomApplcation extends Application {
	...
	//设置为静态变量，方便了获取CustomApplication对象的实例，不再需要通过Activity.getApplication()
	//获取后再强制转换类型
	public static CustomApplcation mInstance;
	public LocationClient mLocationClient;//百度地图的定位类
	public MyLocationListener mMyLocationListener;//实时位置回调监听

	public static BmobGeoPoint lastPoint = null;// 上一次定位到的经纬度,经纬度均用double类型表示
	...
	private void init() {
		//create方法可以便捷的创建MediaPlayer，且自动调用prepare方法
